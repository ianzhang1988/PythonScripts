...
def main():
    ...
    file_name = ['out_00000_dash1.m4s', 'out_00000_dash2.m4s', 'out_00000_dash3.m4s',
                 'out_00000_dash4.m4s','out_00000_dash5.m4s']
    input = [os.path.join('input', i) for i in file_name]
    output = [os.path.join('output', 'seq-'+i) for i in file_name]
